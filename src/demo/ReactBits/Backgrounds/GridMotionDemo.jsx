...
import GridMotion from '../../../content/ReactBits/Backgrounds/GridMotion/GridMotion';
import { gridMotion } from '../../../constants/code/ReactBits/Backgrounds/gridMotionCode';
        ...
        <PreviewTab>
          ...
          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              ...
              defaultProps={{ gradientColor: '#1620E4' }}
            />
          </Flex>
