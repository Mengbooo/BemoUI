...
import PreviewInput from '../_shared/PreviewInput';
import PreviewColorPickerCustom from '../_shared/PreviewColorPickerCustom';

import CurvedInput from '../../../content/ReactBits/Components/CurvedInput/CurvedInput';
import { curvedInput } from '../../../constants/code/ReactBits/Components/curvedInputCode';
        ...
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} overflow="hidden" display="flex" alignItems="center" justifyContent="center" px={{ base: 4, md: 12 }}>
            <Box w="100%" maxW="720px" display="flex" justifyContent="center">
              <CurvedInput {...props} placeholder="hello@bemoui.dev" onSubmit={value => console.log('Submitted:', value)} />
            </Box>
          </Box>
