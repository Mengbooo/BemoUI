...
const DefaultCursorSVG: FC = () => {
  return (
    <svg
      ...
      viewBox="0 0 50 54"
      fill="none"
      className="block origin-center scale-50"
      aria-hidden="true"
      focusable="false"
    >
      <g filter="url(#bemo-smooth-cursor-tw-shadow)">
        <path
      ...
      <defs>
        <filter
          id="bemo-smooth-cursor-tw-shadow"
          x={0.602397}
          y={0.952444}
          width={49.0584}
          height={52.428}
...
const defaultSpringConfig: SmoothCursorSpringConfig = {
  damping: 45,
  stiffness: 400,
  mass: 1,
  restDelta: 0.001,
...
export default function SmoothCursor({
  ...
  return (
    <motion.div
      className="pointer-events-none fixed z-[100] will-change-transform motion-reduce:transition-none"
      style={{
        left: cursorX,
        top: cursorY,
        translateX: '-50%',
...
/*
Required global CSS (Tailwind v4) — no custom keyframes; motion is spring-driven by framer-motion.
Add once in your global stylesheet:

html:has([data-bemo-smooth-cursor]),
html:has([data-bemo-smooth-cursor]) * {
