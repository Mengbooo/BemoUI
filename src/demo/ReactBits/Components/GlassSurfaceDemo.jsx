...
import logo from '../../../assets/logos/bemoUI-icon.svg';

import LiquidEther from '../../../content/ReactBits/Backgrounds/LiquidEther/LiquidEther';
import { glassSurface } from '../../../constants/code/ReactBits/Components/glassSurfaceCode';
import GlassSurface from '../../../content/ReactBits/Components/GlassSurface/GlassSurface';
              ...
              <>
                ...
                <Box position="absolute" top="2em" left={0} width="100%" height="60px" zIndex={0} pointerEvents="none">
                  <GlassSurface className="custom-glass-surface" width="90%" height={60} {...commonGlassProps}>
                    <img src={logo} alt="BemoUI Logo" style={{ height: '24px', borderRadius: '50px' }} />
