...
function ToolbarButton({ children, onClick, disabled = false, ariaLabel, className = '' }) {
  return (
    <button
      type="button"
              ...
              <AnimatePresence mode="wait" initial={false}>
                {!isOpen ? (
                  ...
                  >
                    ...
                    <ToolbarButton onClick={handleOpen} disabled={disabled} ariaLabel={searchAriaLabel}>
                  ...
                  >
                    ...
                    <form className="relative flex w-full min-w-0 flex-1 items-center" onSubmit={handleSubmit} role="search">
...
/* Tailwind v4 keyframes (optional, none required for spring layout):
