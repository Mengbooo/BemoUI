...
export function Android({
  ...
  const rootClass = [
    'bemo-android',
    disabled ? 'bemo-android--disabled' : '',
    className,
  ]
    .filter(Boolean)
    .join(' ');
  ...
  return (
    ...
    >
      <path
        ...
        className="bemo-android__button"
      />
      <path
      ...
      <g clipPath={`url(#${clipId})`}>
        <path
          ...
          className="bemo-android__screen"
        />
      </g>
      <circle cx="189" cy="28" r="9" className="bemo-android__camera" />
      <circle cx="189" cy="28" r="4" className="bemo-android__lens" />
      {src ? (
        <image
          href={src}
          x={9}
      ...
      {videoSrc ? (
        <foreignObject
          ...
          clipPath={`url(#${clipId})`}
        >
          <div xmlns="http://www.w3.org/1999/xhtml" className="bemo-android__video-wrap">
            <video
              className="bemo-android__video"
              src={videoSrc}
