...
export function HyperText({
  ...
  return (
    <MotionComponent
      ref={elementRef}
      className={cn(
        'relative inline-block overflow-hidden border-b-2 border-transparent py-2 text-4xl font-bold leading-tight text-neutral-900 outline-none transition-[color,border-color,opacity] duration-200',
        interactive &&
          'hover:border-[#7BE9C6] hover:text-[#1620E4] focus-visible:border-[#7BE9C6] focus-visible:text-[#1620E4]',
        'focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#1620E4]',
        disabled && 'cursor-not-allowed text-neutral-500 opacity-60',
        className
      )}
...
/* Tailwind v4 global keyframes: none required. The scramble effect is driven by requestAnimationFrame in JS and respects prefers-reduced-motion. */
