...
/**
 * TwentyFirstCultFamilyButton (Tailwind v4 self-contained)
...
export function TwentyFirstCultFamilyButton({
  ...
  return (
    <div
      ...
      style={{
        '--tw-cult-accent': accent,
        '--tw-cult-accent-soft': accentSoft,
      }}
            ...
            >
              <AnimatePresence mode="wait">
                {isExpanded ? (
                  <motion.div
                    key="content"
                    className="w-full h-full flex flex-col items-stretch justify-start overflow-auto p-3 pb-13 sm:p-3 sm:pb-13"
                ...
                >
                  ...
                  >
                    {isExpanded ? (
                      ...
                      <Plus className="size-7 shrink-0 text-black" aria-hidden="true" />
                    )}
                  </motion.span>
                </button>
              </motion.div>
