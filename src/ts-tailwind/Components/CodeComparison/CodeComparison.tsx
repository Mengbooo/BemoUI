...
/* Tailwind v4 global keyframes (optional):
   ...
   Default component uses CSS transitions only; no keyframes required. Honor prefers-reduced-motion via motion-safe utilities.
*/
