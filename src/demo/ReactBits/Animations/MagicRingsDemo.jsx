...
import MagicRings from '../../../content/ReactBits/Animations/MagicRings/MagicRings';
import { magicRings } from '../../../constants/code/ReactBits/Animations/magicRingsCode';
...
const MagicRingsDemo = () => {
  ...
  const propData = useMemo(
    () => [
      { name: 'color', type: 'string', default: '"#1620E4"', description: 'Hex color for the rings.' },
            ...
            {example === 'card' ? (
              <div className="mr-demo-card">
                <div className="mr-demo-card-visual">
                  ...
                  />
                  <Icon as={Sparkles} strokeWidth={1} boxSize={12} color="#1620E4" position="absolute" top="50%" left="50%" transform="translate(-50%, -50%)" opacity={0.8} />
                </div>
