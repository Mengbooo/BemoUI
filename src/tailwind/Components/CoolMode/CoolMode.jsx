...
function applyParticleEffect(element, options = {}) {
  ...
  const generateParticle = () => {
    ...
    particle.className = 'pointer-events-none absolute select-none will-change-transform motion-reduce:hidden';
...
export default function CoolMode({
  ...
  return (
    <span
      ref={ref}
      className={["inline-flex items-center justify-center relative touch-manipulation focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1620E4] focus-visible:rounded-md data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-60", className].filter(Boolean).join(' ')}
