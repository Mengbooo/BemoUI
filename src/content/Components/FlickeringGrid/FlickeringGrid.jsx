...
function colorToRgbaPrefix(color) {
  if (typeof color !== 'string') return 'rgba(22, 32, 228,';
...
const FlickeringGrid = ({
  ...
  const rootClassName = ['bemo-flickering-grid', className].filter(Boolean).join(' ');
  ...
  return (
    ...
    >
      <canvas
        ref={canvasRef}
        className="bemo-flickering-grid__canvas"
        aria-hidden="true"
