...
import { blobCursor } from '../../../constants/code/ReactBits/Animations/blobCursorCode';
import BlobCursor from '../../../ts-tailwind/ReactBits/Animations/BlobCursor/BlobCursor';
...
const BlobCursorDemo = () => {
  ...
  const propData = useMemo(
    () => [
      ...
      { name: 'fillColor', type: 'string', default: "'#1620E4'", description: 'Background color of each blob.' },
