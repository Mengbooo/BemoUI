...
export default function Iphone({
  ...
  return (
    ...
    >
      {hasVideo && (
        <div
          className="pointer-events-none absolute z-0 overflow-hidden bg-linear-to-br from-[#1620E4] via-[#0a0f6e] to-[#7BE9C6]"
          style={screenStyle}
        >
          <video
      ...
      {hasChildren && (
        <div
          ...
          style={screenStyle}
        >
          <div className="block size-full overflow-hidden">{children}</div>
        </div>
      )}
      ...
      <svg
        ...
        className="absolute inset-0 size-full [transform:translateZ(0)]"
        aria-hidden="true"
        focusable="false"
      >
        ...
        <path
          ...
          className="fill-[#1620E4] dark:fill-[#7BE9C6]"
        />
