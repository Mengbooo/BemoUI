    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          isHovered && 'shadow-[0_4px_12px_rgba(22,32,228,0.12),0px_1px_1px_0px_rgba(0,0,0,0.05),0px_1px_1px_0px_rgba(255,252,240,0.5)_inset,0px_0px_0px_1px_hsla(0,0%,100%,0.1)_inset]',
