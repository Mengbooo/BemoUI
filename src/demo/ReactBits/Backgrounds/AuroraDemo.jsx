...
import Aurora from '../../../content/ReactBits/Backgrounds/Aurora/Aurora';
import { aurora } from '../../../constants/code/ReactBits/Backgrounds/auroraCode';
        ...
        <PreviewTab>
          ...
          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              ...
              defaultProps={{ colorStops: ['#1620E4', '#7cff67', '#1620E4'], speed: 1, blend: 0.5 }}
            />
          </Flex>
