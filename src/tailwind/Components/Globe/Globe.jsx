  ...
  return (
    <div
      ...
      className={classNames(
        'relative mx-auto block aspect-square w-full max-w-[37.5rem]',
        disabled && 'opacity-70',
        className
      )}
    >
      <canvas
        ref={canvasRef}
        className={classNames(
          'block size-full touch-none rounded-full bg-[radial-gradient(circle_at_50%_45%,rgba(123,233,198,0.12),transparent_58%)] contain-[layout_paint_size] transition-opacity duration-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#1620E4] focus-visible:shadow-[0_0_0_6px_rgba(123,233,198,0.28)]',
...
/*
Tailwind v4 global keyframes (add to your CSS entry if fade helpers are needed):
@keyframes bemo-globe-fade-in {
  from { opacity: 0; }
  to { opacity: 1; }
}
