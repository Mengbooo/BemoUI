...
const InteractiveHoverButton = ({
  ...
  return (
    <button type={type} className={classes} disabled={disabled} {...props}>
      ...
      <span className="pointer-events-none absolute inset-0 -z-10 rounded-full bg-transparent transition-colors duration-200 motion-reduce:group-hover:bg-[#1620E4] motion-reduce:group-hover:border-[#1620E4]" aria-hidden="true" />
    </button>
  );
};
