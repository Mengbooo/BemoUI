...
import LineSidebar from '../../../content/ReactBits/Components/LineSidebar/LineSidebar';
import { lineSidebar } from '../../../constants/code/ReactBits/Components/lineSidebarCode';
...
const LineSidebarDemo = () => {
  ...
  const propData = useMemo(
    () => [
      ...
      { name: 'accentColor', type: 'string', default: '"#1620E4"', description: 'Color items and markers shift toward as the cursor gets close.' },
