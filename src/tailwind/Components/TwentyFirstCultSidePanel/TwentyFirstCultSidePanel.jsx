...
const TwentyFirstCultSidePanel = forwardRef(function TwentyFirstCultSidePanel(
  ...
  const defaultButton = (toggle) => (
    <button
      ...
      disabled={disabled}
      style={{ '--tw-accent': accentColor, '--tw-accent-sec': accentSecondary }}
    >
      <span className="inline-flex text-[#7BE9C6]" aria-hidden="true" style={{ color: accentSecondary }}>
    ...
    <ResizablePanel ref={ref}>
      <motion.div
        ...
        style={{
          ...
          width: panelOpen ? undefined : (typeof closedWidth === 'number' ? `${closedWidth}px` : closedWidth),
        }}
      ...
      >
        <motion.div
          animate={{
            height: prefersReducedMotion ? 'auto' : bounds.height > 0 ? bounds.height : 0.1,
          }}
          className="h-auto"
          transition={
