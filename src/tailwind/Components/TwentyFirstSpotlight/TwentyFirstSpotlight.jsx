...
/* Tailwind v4 note: no custom keyframes required. Uses built-in transition-opacity and blur utilities. For reduced-motion, pair with motion-reduce: variants or the media query handled in JS. */
