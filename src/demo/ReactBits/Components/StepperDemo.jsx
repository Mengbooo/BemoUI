...
import Stepper, { Step } from '../../../content/ReactBits/Components/Stepper/Stepper';
import { stepper } from '../../../constants/code/ReactBits/Components/stepperCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} overflow="hidden">
            ...
            >
              <Step>
                <Text color="#1620E4" fontSize="1.2rem" fontWeight={600}>
                  Welcome to the BemoUI stepper!
                </Text>
