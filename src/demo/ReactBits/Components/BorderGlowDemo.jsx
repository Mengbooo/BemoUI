...
import BorderGlow from '../../../content/ReactBits/Components/BorderGlow/BorderGlow';
import { borderGlow } from '../../../constants/code/ReactBits/Components/borderGlowCode';
...
const BorderGlowDemo = () => {
  ...
  const [colors, setColors] = useState(['#7BE9C6', '#7BE9C6', '#38bdf8']);
