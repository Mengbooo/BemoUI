...
import TextType from '../../../content/ReactBits/TextAnimations/TextType/TextType';
import { textType } from '../../../constants/code/ReactBits/TextAnimations/textTypeCode';

const DEFAULT_PROPS = {
  texts: ['Welcome to BemoUI! Good to see you!', 'Build some amazing experiences!'],
  typingSpeed: 75,
  pauseDuration: 1500,
  deletingSpeed: 50,
  showCursor: true,
