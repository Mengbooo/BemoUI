import React, { useCallback, useMemo, type CSSProperties, type HTMLAttributes, type ReactNode } from 'react';
...
function Beam({ width, x, delay, duration, color, aspectRatio }: BeamProps) {
