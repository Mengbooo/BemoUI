    ...
    <AnimatePresence>
      {context.isOpen && (
        <motion.div
          ...
          aria-modal="true"
          tabIndex={-1}
          className={`absolute z-50 min-w-[12rem] max-w-[min(20rem,calc(100vw-2rem))] overflow-hidden rounded-lg border border-black/10 bg-white p-3 text-neutral-950 shadow-md focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#7BE9C6] dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-50 ${className}`.trim()}
          initial="initial"
          animate="animate"
          exit="exit"
