...
/* Tailwind v4 keyframes (none required for core animation — framer-motion handles motion).
   Optional reduced-motion is handled in JS. If pure CSS fallback needed:
