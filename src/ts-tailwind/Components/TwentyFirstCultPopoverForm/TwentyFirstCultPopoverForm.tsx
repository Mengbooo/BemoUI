...
function PopoverFormCutOutTopIcon({
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <g clipPath="url(#bemo-tstw-clip-cutout-top)">
        <path
      ...
      <defs>
        <clipPath id="bemo-tstw-clip-cutout-top">
...
export interface TwentyFirstCultPopoverFormSuccessProps {
  title?: string;
  description?: string;
}
...
}: TwentyFirstCultPopoverFormSuccessProps): React.ReactElement {
  return (
...
export interface TwentyFirstCultPopoverFormButtonProps
...
export function TwentyFirstCultPopoverFormButton({
  ...
  className = '',
  ...props
}: TwentyFirstCultPopoverFormButtonProps): React.ReactElement {
...
export interface TwentyFirstCultPopoverFormSeparatorProps {
  width?: number | string;
  height?: number;
  className?: string;
}
...
export function TwentyFirstCultPopoverFormSeparator({
  ...
  height = 2,
  className = '',
}: TwentyFirstCultPopoverFormSeparatorProps): React.ReactElement {
  return (
    <svg
...
export interface TwentyFirstCultPopoverFormProps {
  open: boolean;
...
export function TwentyFirstCultPopoverForm({
  ...
  disabled = false,
  onOpenChange,
}: TwentyFirstCultPopoverFormProps): React.ReactElement {
