...
const intentClasses: Record<NeumorphIntent, string> = {
  default:
...
const sizeClasses: Record<NeumorphSize, string> = {
...
Tailwind v4 animate-spin + motion-reduce:animate-none for reduced motion.
*/
